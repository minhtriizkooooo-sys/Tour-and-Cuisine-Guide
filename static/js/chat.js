...
function renderHistory() {
  ...
  chatHistory.forEach(msg => {
    appendMessage(msg.role, msg.content, msg.media);
  });
}
...
function appendMessage(role, text, media = []) {
  ...
  media.forEach(m => {
    if (m.type === "image") {
      ...
      img.onclick = () => openImageModal(m.src, m.caption);
